...
SECTOR_META: dict = _METADATA["sector_meta"]
SECTOR_TO_THEME_KEYWORD: dict = _METADATA["sector_to_theme_keyword"]
MACRO_ORDER: list = _METADATA["macro_order"]
MACRO_META: dict = _METADATA["macro_meta"]
...
MC_INVERT = {"TLT", "LQD"}
THEME_LABELS: dict = _METADATA["theme_labels"]
BENCHMARK_LABELS: dict = _METADATA["benchmark_labels"]
...
def build_pt_single_card(ticker: str, item: dict, tag_data: dict, in_watchlist: bool, lang: str = "EN") -> dict:
    ...
    is_penny_mode = current_price < 50.0
        ...
        "contents": [
            {
                ...
                "contents": [
                    {"type": "box", "layout": "vertical", "width": "32px", "height": "32px", "cornerRadius": "16px",
                     "backgroundColor": "#F1F5F9", "contents": [ticker_logo(ticker)]},
